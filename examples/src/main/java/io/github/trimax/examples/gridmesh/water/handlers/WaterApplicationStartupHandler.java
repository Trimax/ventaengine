...
public final class WaterApplicationStartupHandler implements VentaEngineStartupHandler {
    ...
    public void onStartup(final String[] args, final VentaContext context) {
        ...
        final var water = context.getGridMeshManager().create("Water", context.getGridMeshRepository().get("water2.json"));
        ...
        camera.setPosition(new Vector3f(0f, 15f, 0f));
        camera.lookAt(new Vector3f(-1f, 15f, -1f));
