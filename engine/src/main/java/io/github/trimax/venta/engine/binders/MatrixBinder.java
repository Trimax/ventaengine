...
public final class MatrixBinder extends AbstractBinder {
    public void bind(final ProgramManagerImplementation.ProgramEntity program, final FloatBuffer matrixViewProjection, final FloatBuffer matrixModel, final FloatBuffer matrixNormal) {
