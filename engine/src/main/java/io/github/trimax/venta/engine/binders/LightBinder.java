...
public final class LightBinder extends AbstractBinder {
    public void bind(final ProgramInstance program, final Vector4f ambientLight) {
        bind(program.getUniformID(ShaderUniform.AmbientLight), ambientLight);
    }

    public void bind(final ProgramInstance program, final List<? extends LightView> lights) {
    ...
    private void bind(final ProgramInstance program, final LightView light, final int lightIndex) {
