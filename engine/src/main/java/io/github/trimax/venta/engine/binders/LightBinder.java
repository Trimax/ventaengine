...
public final class LightBinder extends AbstractBinder {
    public void bind(final ProgramInstanceImplementation program, final Vector4f ambientLight) {
        bind(program.getUniformID(ShaderUniform.AmbientLight), ambientLight);
    }

    public void bind(final ProgramInstanceImplementation program, final List<? extends LightInstance> lights) {
    ...
    private void bind(final ProgramInstanceImplementation program, final LightInstance light, final int lightIndex) {
