...
public final class LightBinder extends AbstractBinder {
    public void bind(final ProgramManager.ProgramEntity program, final Vector4f ambientLight) {
    ...
    private void bind(final ProgramManager.ProgramEntity program, final LightView light, final int lightIndex) {
