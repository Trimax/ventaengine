    ...
    public float[] getVerticesArray() {
        ...
        for (int vertexID = 0; vertexID < vertices.size(); vertexID++) {
            ...
            if (vertex.hasPosition()) {
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_POSITION_X] = vertex.position().x();
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_POSITION_Y] = vertex.position().y();
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_POSITION_Z] = vertex.position().z();
            }

            if (vertex.hasNormal()) {
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_NORMAL_X] = vertex.normal.x();
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_NORMAL_Y] = vertex.normal.y();
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_NORMAL_Z] = vertex.normal.z();
            }

            if (normal != null) {
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_NORMAL_X] = normal.x();
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_NORMAL_Y] = normal.y();
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_NORMAL_Z] = normal.z();
            }

            if (vertex.hasTextureCoordinates()) {
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_TEXTURE_COORDINATES_U] = vertex.textureCoordinates().x();
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_TEXTURE_COORDINATES_V] = vertex.textureCoordinates().y();
            }

            if (vertex.hasColor()) {
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_COLOR_R] = vertex.color().x();
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_COLOR_G] = vertex.color().y();
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_COLOR_B] = vertex.color().z();
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_COLOR_A] = vertex.color().w();
            }

            if (tangent != null) {
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_TANGENT_X] = tangent.x();
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_TANGENT_Y] = tangent.y();
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_TANGENT_Z] = tangent.z();
            }

            if (bitangent != null) {
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_BITANGENT_X] = bitangent.x();
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_BITANGENT_Y] = bitangent.y();
                packedArray[VERTEX_FLOATS_COUNT * vertexID + VERTEX_OFFSET_BITANGENT_Z] = bitangent.z();
            }
        }
